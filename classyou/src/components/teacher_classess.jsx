...
export default function TeacherClassess(props){
    return(
        <div>
            ...
            <h3 className="pt-1">{props.user.title}</h3>
            {(props.user.teacher) && <Link to="/admin/class/create" className="border-2 border-black border-b-4 bg-green-500 rounded-3xl px-2 text-white hover:bg-white hover:text-black">+</Link>}
            </div>
